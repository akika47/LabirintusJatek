const languages = {
    spanish: {
      ...
      drillplace: "Coloque los taladros con <b>G</b>",
    ...
    hungarian: {
      ...
      drillplace: "<b>G</b>-vel fúrot lehet letenni",
    ...
    english: {
        ...
        drillplace: "Place down drills with <b>G</b>",
...
document.getElementById("spanish").addEventListener("click", function() {
  ...
  function updateLanguage() {
    ...
    document.getElementById("game-control").innerHTML =
      ...
      "<p>" + languages[currentLanguage].drillplace + "</p>" +
